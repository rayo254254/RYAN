## A possibility: search 4 from the backend
# numbers = (4, 2, 3, 9, 1, 4)
# print(numbers)
# found = False
# index = len(numbers)
...
# #Loop trough list, store index of digit if == 4 --> index is always overwriting and lest occurance is kept
...
## Another possibility: converst the tuple to a list and reverse twice
# if 4 not in numbers:
#     print('The number 4 does not appear in the Tuple')
# else:
